...
const DEFAULT_MODEL = 'llama3:8b'; // Modelo padrão
...
export class OllamaService {
  ...
  /**
   * Gera uma resposta do modelo Llama com base no contexto e na mensagem do usuário.
   */
...
IMPORTANTE:
- Use APENAS as informações da BASE DE CONHECIMENTO abaixo para responder. NÃO invente informações.
- Se não encontrar informações relevantes, diga: "Desculpe, não tenho informações específicas sobre isso na minha base de conhecimento atual. Posso ajudá-lo com algo mais relacionado ao que foi treinado?"
...
RESPOSTA (baseada apenas na base de conhecimento):`;
  ...
  /**
   * Processa e organiza o conteúdo de um documento.
   */
